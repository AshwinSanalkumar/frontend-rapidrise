      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <section className="lg:col-span-4 bg-white dark:bg-gray-800 p-6 sm:p-10 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col items-center text-center">
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700 w-full">
            ...
            {/* Danger Zone - Desktop Only (visible lg+) */}
            <div className="hidden lg:flex bg-red-50 dark:bg-red-900/10 p-5 rounded-[2rem] border border-red-100 dark:border-red-900/30 shadow-sm mt-6 flex-col items-center">
        ...
        <section className="lg:col-span-8 space-y-6">
          ...
          {/* Danger Zone - Mobile Only (hidden on lg+) */}
          <div className="lg:hidden bg-red-50 dark:bg-red-900/10 p-8 rounded-[2.5rem] border border-red-100 dark:border-red-900/30 shadow-sm flex flex-col items-center text-center">
            <div className="w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-2xl text-red-600 flex items-center justify-center mb-6">
            ...
            <p className="text-sm text-red-500/80 dark:text-red-400/80 font-medium px-4 mb-8 leading-relaxed">
              Deactivate and delete your account and all associated data.

            </p>
            <button
              onClick={() => setIsDeactivateModalOpen(true)}
              className="w-full bg-red-600 text-white font-bold py-4 rounded-xl hover:bg-red-700 shadow-lg shadow-red-500/20 transition active:scale-95 text-sm  tracking-widest"
            >
              Confirm Deletion
            </button>
          </div>
