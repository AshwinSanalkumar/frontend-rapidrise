...
const DropdownMenu = ({ onRename, onDelete, close }) => (
  <div 
    ...
    className="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-700 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-600 z-30 overflow-hidden"
  >
    <button 
...
export default FolderCard; // CRITICAL: This fixed your SyntaxError